...
[params.model.A, params.model.B] = generate_system_scaled(At,Bt,params);

[params.constraints.InputMatrix, params.constraints.InputRHS, ...
 params.constraints.StateMatrix, params.constraints.StateRHS] = generate_constraints(params);
end
