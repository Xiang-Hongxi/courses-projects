...
alpha_x = ...;  # Focal length in pixels along camera's X axis (horizontal)
alpha_y = ...;  # Focal length in pixels along camera's Y axis (vertical)
u0 = ...;   # Center of image plane in pixels along horizontal direction
v0 = ...;   # Center of image plane in pixels along vertical direction
K = ...;    # 3x3 intrinsic camera calibration matrix
...
z_triangulated = lambda disparity: ...
