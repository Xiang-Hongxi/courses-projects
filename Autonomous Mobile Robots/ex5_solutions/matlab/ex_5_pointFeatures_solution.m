...
% contains elements non-zero and the rotation is not the identity.
...
% SOLUTION: No, since the Harris corner detector is not scale invariant and will therefore not detect
% the same keypoints in the images.

% TODO: If not, what type of other feature could you we use to solve this problem?
% SOLUTION: To solve this problem, one could use any other feature detector that is scale invariant.
