...
#right_lena = cv.imread('right_lena.jpg', cv.IMREAD_GRAYSCALE)
lena = cv.imread('D:/courses/Autonomous Mobile Robots/Ex5_solutions/python/lena.jpeg', cv.IMREAD_GRAYSCALE)
left_lena = cv.imread('D:/courses/Autonomous Mobile Robots/Ex5_solutions/python/left_lena.jpg', cv.IMREAD_GRAYSCALE)
right_lena = cv.imread('D:/courses/Autonomous Mobile Robots/Ex5_solutions/python/right_lena.jpg', cv.IMREAD_GRAYSCALE)
...
# for feature matching between the image pairs. We will use SIFT feature
...
# SOLUTION:
# We didn't achieve a perfect alignment since our translation vector
# contains a non-zero vertical component and the rotation is not the identity.
# This may have been caused by wrong keypoint matches between the images
