...
fig2b, ax2b = plt.subplots(1, 2, num='Q3.4b Image alignment, rotation - Harris corners')
fig2b.set_size_inches(8, 5)
ax2b[0].imshow(left_J, cmap='gray')
ax2b[0].set_title('Left corners marked')
ax2b[1].imshow(right_J, cmap='gray')
ax2b[1].set_title('Right corners marked')
